...
app.get('/:calcOperation', (req, res) => {
    try {
        ...
        logManager.info(`New ${calcOperation} operation requested: ${value1} ${calcOperation} ${value2}`);
...
app.listen(serverPort, () => {
    console.log(`Calculator microservice running on http://localhost:${serverPort}`);
});
